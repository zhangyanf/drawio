...
App = function(editor, container, lightbox) {
  EditorUi.call(
    ...
    editor,
    container,
    lightbox != null ? lightbox : urlParams["lightbox"] == "1"
  );
  ...
  if (!this.isOffline()) {
    EditDataDialog.placeholderHelpLink =
      "http://developers.inhandnetworks.com/";
  }
  ...
  mxUtils.getAll(
    ...
    function(xhr) {
      ...
      var ui =
        createUi != null
          ? createUi()
          : new App(new Editor(urlParams["chrome"] == "0"));
      ...
      if (window.mxscript != null) {
        ...
        if (
          ...
          (typeof window.Trello === "undefined" &&
            ...
            (((urlParams["embed"] != "1" && urlParams["tr"] != "0") ||
              (urlParams["embed"] == "1" && urlParams["tr"] == "1")) &&
              (navigator.userAgent.indexOf("MSIE") < 0 ||
                document.documentMode >= 10)))
        ) {
      ...
      if (urlParams["chrome"] != "0" && urlParams["test"] == "1") {
        mxLog.show();
        mxLog.debug(
          "Started in " + (new Date().getTime() - t0.getTime()) + "ms"
        );
        mxLog.debug("Export:", EXPORT_URL);
        mxLog.debug(
          "Development mode:",
          urlParams["dev"] == "1" ? "active" : "inactive"
        );
        mxLog.debug(
          "Test mode:",
          urlParams["test"] == "1" ? "active" : "inactive"
        );
      }
    },
    function() {
      document.getElementById("geStatus").innerHTML =
        'Error loading page. <a href="javascript:void(0);" onclick="location.reload();">Please try refreshing.</a>';
    }
  );
};
 ...
 * Executes the first step for connecting to Google Drive.
 */
App.prototype.defaultUserPicture =
  "https://lh3.googleusercontent.com/-HIzvXUy6QUY/AAAAAAAAAAI/AAAAAAAAAAA/giuR7PQyjEk/photo.jpg?sz=30";
    ...
    var initDriveClient = mxUtils.bind(this, function() {
      ...
      if (typeof gapi !== "undefined") {
            ...
            this.editor.addListener(
              ...
              mxUtils.bind(this, function() {
                ...
                if (file != null && file.constructor == DriveFile) {
                  ...
                  if (td != null) {
                    td.innerHTML =
                      '<a href="https://support.draw.io/display/DO/2014/11/27/Switching+application+in+Google+Drive" ' +
        ...
        if (window.DrawGapiClientCallback != null) {
          gapi.load(
            (urlParams["picker"] != "0" ? "picker," : "") +
              "auth:client,drive-realtime,drive-share",
...
App.prototype.isLegacyDriveDomain = function() {
  return (
    urlParams["drive"] == 0 || window.location.hostname == "legacy.draw.io"
  );
};
...
App.prototype.checkLicense = function() {
  ...
  var email =
    (urlParams["dev"] == "1" ? urlParams["lic"] : null) ||
  ...
  if (!this.isOffline() && !this.editor.chromeless && email != null) {
    ...
    mxUtils.post(
      ...
      "domain=" +
        ...
        "&ds=" +
        encodeURIComponent(driveUser.displayName) +
        "&lc=" +
        encodeURIComponent(driveUser.locale) +
        "&ts=" +
        new Date().getTime(),
  ...
  if (footer != null && lic != null) {
    ...
    if (lic.footer != null) {
      ...
      if (expiry != null && expiry != "never") {
        ...
        if (diff < 90) {
          var link =
            "https://support.draw.io/display/DKB/draw.io+footer+state+that+license+is+expiring+on+Google+For+Work+account?domain=" +
            encodeURIComponent(domain);
          ...
          if (diff < 0) {
            ...
            footer.innerHTML =
              '<table height="100%"><tr><td valign="middle" align="center" class="geStatusAlert geBlink">' +
              '<a href="' +
              link +
              '" style="padding-top:16px;" target="_blank">' +
              '<img border="0" src="' +
              mxGraph.prototype.warningImage.src +
              '" align="top" style="margin-right:6px">' +
              mxResources.get("licenseHasExpired", [
                domain,
            ...
            footer.innerHTML =
              '<table height="100%"><tr><td valign="middle" align="center" class="geStatusAlert">' +
              '<a href="' +
              link +
              '" target="_blank">' +
              '<img border="0" src="' +
              mxGraph.prototype.warningImage.src +
              '" align="top" style="margin-right:6px">' +
              mxResources.get("licenseWillExpire", [
                domain,
                exp.toLocaleDateString()
              ]) +
              "</a></td></tr></table>";
...
App.prototype.getThumbnail = function(width, success) {
  ...
  try {
    ...
    if (
      ...
      (!graph.mathEnabled && this.useCanvasForExport)
    ) {
      this.exportToCanvas(
...
App.prototype.showSplash = function(force) {
  ...
  var showSecondDialog = mxUtils.bind(this, function() {
    ...
    this.showDialog(
      dlg.container,
      340,
      serviceCount < 2 || mxClient.IS_CHROMEAPP || EditorUi.isElectronApp
        ? 200
        : 260,
      true,
      true,
...
App.prototype.defineCustomObjects = function() {
  if (gapi.drive.realtime != null && gapi.drive.realtime.custom != null) {
    ...
    mxRtCell.prototype.cellId = gapi.drive.realtime.custom.collaborativeField(
      "cellId"
    );
    mxRtCell.prototype.type = gapi.drive.realtime.custom.collaborativeField(
      "type"
    );
    mxRtCell.prototype.value = gapi.drive.realtime.custom.collaborativeField(
      "value"
    );
    mxRtCell.prototype.xmlValue = gapi.drive.realtime.custom.collaborativeField(
      "xmlValue"
    );
    mxRtCell.prototype.style = gapi.drive.realtime.custom.collaborativeField(
      "style"
    );
    mxRtCell.prototype.geometry = gapi.drive.realtime.custom.collaborativeField(
      "geometry"
    );
    mxRtCell.prototype.visible = gapi.drive.realtime.custom.collaborativeField(
      "visible"
    );
    mxRtCell.prototype.collapsed = gapi.drive.realtime.custom.collaborativeField(
      "collapsed"
    );
    mxRtCell.prototype.connectable = gapi.drive.realtime.custom.collaborativeField(
      "connectable"
    );
    mxRtCell.prototype.parent = gapi.drive.realtime.custom.collaborativeField(
      "parent"
    );
    mxRtCell.prototype.children = gapi.drive.realtime.custom.collaborativeField(
      "children"
    );
    mxRtCell.prototype.source = gapi.drive.realtime.custom.collaborativeField(
      "source"
    );
    mxRtCell.prototype.target = gapi.drive.realtime.custom.collaborativeField(
      "target"
    );
  }
};
    ...
    var peer =
      mode == App.MODE_GOOGLE
        ...
        : mode == App.MODE_ONEDRIVE
          ...
          : mode == App.MODE_GITHUB
            ? this.gitHub
            : mode == App.MODE_TRELLO ? this.trello : this.dropbox;
  ...
  if (file != null) {
    ...
    if (!forceDialog && file.getTitle() != null && this.mode != null) {
      ...
      var dlg = new CreateDialog(
        this,
        filename,
        mxUtils.bind(this, function(name, mode) {
              ...
              this.pickFolder(
                ...
                mxUtils.bind(this, function(folderId) {
                  this.createFile(
                    name,
                    this.getFileData(
                      /(\.xml)$/i.test(name) || name.indexOf(".") < 0,
                      /(\.svg)$/i.test(name),
                      /(\.html)$/i.test(name)
                    ),
                    null,
  ...
  if (
    ...
    if (mode == App.MODE_GOOGLE && this.drive != null) {
      ...
      if (localStorage.getItem(title) == null) {
        ...
        this.confirm(
          mxResources.get("replaceIt", [title]),
          fn,
          mxUtils.bind(this, function() {
                ...
                if (
                  ...
                  var fallback = mxUtils.bind(this, function() {
                    if (this.drive != null) {
                      this.spinner.stop();
                      this.loadFile(
                        "G" + url.substring(31, url.lastIndexOf("&")),
                        sameWindow
                      );
                  ...
                  mxUtils.get(
                    ...
                    mxUtils.bind(this, function(req) {
                      if (req.getStatus() >= 200 && req.getStatus() <= 299) {
                        try {
                          this.loadLibrary(
                            new UrlLibrary(this, req.getText(), url)
                          );
                          delete this.pendingLibraries[id];
                        } catch (e) {
                          ignore(id);
...
App.prototype.toggleChat = function() {
  ...
  if (file != null) {
    if (file.chatWindow == null) {
      ...
      file.chatWindow = new ChatWindow(
        this,
        mxResources.get("chatWindowTitle"),
        document.getElementById("geChat"),
        cwLeft,
        80,
        250,
        350,
...
App.prototype.updateHeader = function() {
  if (this.menubar != null) {
    ...
    this.toggleFormatElement.style.right =
      uiTheme != "atlas" && urlParams["embed"] != "1" ? "26px" : "10px";
    ...
    this.fullscreenElement.style.right =
      uiTheme != "atlas" && urlParams["embed"] != "1" ? "42px" : "26px";
          ...
          if (this.userPanel.parentNode != null) {
              ...
              if (driveUser != null) {
                ...
                this.userPanel.innerHTML +=
                  ...
                  (driveUser.pictureUrl != null
                    ? '<img style="margin-right:10px;border-radius:50%;" src="' +
                      driveUser.pictureUrl +
                      '"/>'
                    : '<img style="margin-right:4px;margin-top:2px;" src="' +
                      this.defaultUserPicture +
                      '"/>') +
                  '</td><td valign="top" style="white-space:nowrap;' +
                  (driveUser.pictureUrl != null ? "padding-top:14px;" : "") +
                  '"><b>' +
                  mxUtils.htmlEntities(driveUser.displayName) +
                  "</b><br>" +
                  "<small>" +
                  mxUtils.htmlEntities(driveUser.email) +
                  "</small></tr></table>";
                var div = document.createElement("div");
                        ...
                        this.confirm(
                          ...
                          mxUtils.bind(this, function() {
                            ...
                            window.setTimeout(
                              ...
                              file != null && file.constructor == DriveFile
                                ? 2000
                                : 0
                            );
                          })
            ...
            var addUser = mxUtils.bind(this, function(user, logo, logout) {
              if (user != null) {
                ...
                connected = true;
                this.userPanel.innerHTML +=
                  '<table style="font-size:10pt;padding:20px 20px 10px 10px;"><tr><td valign="top">' +
                  (logo != null
                    ? '<img style="margin-right:10px;" src="' +
                      logo +
                      '" width="40" height="40"/></td>'
                    : "") +
                  '<td valign="middle" style="white-space:nowrap;"><b>' +
                  mxUtils.htmlEntities(user.displayName) +
                  "</b>" +
                  (user.email != null
                    ? '<br><font color="gray">' +
                      mxUtils.htmlEntities(user.email) +
                      "</font></td>"
                    : "") +
                  "</tr></table>";
                var div = document.createElement("div");
                ...
                if (logout != null) {
                  div.appendChild(
                    mxUtils.button(mxResources.get("signOut"), logout)
                  );
                }
